...
use App\Application\Actions\Card\AddCardAction;
use App\Application\Actions\Card\DeleteCardAction;
use App\Application\Actions\Card\EditCardAction;
use App\Application\Actions\Card\GetIconAction;
...
return function (App $app) {
    ...
    $app->group('/api', function (RouteCollectorProxy $group) use ($app) {
        ...
        $group->group('/cards', function (Group $groupCards) {
            $groupCards->post('', AddCardAction::class);
            $groupCards->post('/edit-card/{id}', EditCardAction::class);
